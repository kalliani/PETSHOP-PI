...
public class AgendamentoServicos {
	...
	private static void consultaVeterinario() {
		...
		if (escolha.equals(1)) {
			...
			System.out.print("Diga o dia, mês e horario que deseja para a consulta de rotina (dd/mm/aaaa HH:ss): ");
			...
			System.out.println("Você escolheu consulta de rotina.");
			System.out.print("Diga o dia, mês e horario que deseja para a consulta de emergência (dd/mm/aaaa HH:ss): ");
	...
	private static void banhoTosa() {
		...
		while (true) {
			...
			if (escolha.equals(1)) {
				System.out.print("Me informe o dia e o horario para o banho (dd/mm/aaaa HH:ss): ");
				...
				System.out.print("Me informe o dia e o horario para o banho e tosa (dd/mm/aaaa HH:ss): ");
				...
				System.out.print("Me informe o dia e o horario para o banho e a hidratação (dd/mm/aaaa HH:ss): ");
				...
				System.out.print("Me informe o dia e o horario para o banho e tosa higiênica (dd/mm/aaaa HH:ss): ");
	...
	private static void dayCare() {
		...
		System.out.print("Digite a data de hospedagem do seu pet (dd/mm/aaaa HH:ss):");
